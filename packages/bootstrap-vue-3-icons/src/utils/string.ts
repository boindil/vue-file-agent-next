...
export const lowerFirst = (str: any): string => {
...
export const trimLeft = (str: any): string => toString(str).replace(RX_TRIM_LEFT, '')

// Remove Trailing white space from a string
export const trimRight = (str: any): string => toString(str).replace(RX_TRIM_RIGHT, '')

// Remove leading and trailing white space from a string
export const trim = (str: any): string => toString(str).trim()

// Lower case a string
export const lowerCase = (str: any): string => toString(str).toLowerCase()

// Upper case a string
export const upperCase = (str: any): string => toString(str).toUpperCase()
